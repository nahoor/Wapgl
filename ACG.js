document.addEventListener("DOMContentLoaded", function() {
    ...
    function showurl(datajson) {
        ...
        // Get the first image source, or an empty string if there's none
        ...
        for (var i = 0; i < linktag.length; i++) {
            ...
            if (check == false) {
                // Check if the link's hostname is "drive.google.com"
                if (extractDomain(linktag[i].href) === "drive.google.com") {
                    // Update the link attributes to open in a new tab
